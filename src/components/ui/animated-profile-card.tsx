    ...
    return (
      ...
      >
        <CardHeader className="p-0">
          ...
          <CardDescription
            className={cn(
              "pt-6 text-left whitespace-pre-line",
        ...
        <CardContent className="mt-6 flex-grow p-0">
          <p
            className={cn(
              "text-base leading-relaxed text-left whitespace-pre-line",
          ...
          <CardFooter className={cn("mt-6 p-0", footerClass)}>
            ...
            >
              {socials.map((s) => (
                ...
                >
                  {s.icon} <span className="text-sm border-b border-transparent hover:border-current transition-all pb-1">{s.label}</span>
                </a>
              ))}
            </div>
          </CardFooter>
  ...
  (
    ...
    return (
      <div
        ...
        className={cn(
          "relative w-full max-w-[350px] overflow-hidden rounded-3xl border-2",
          className
        )}
        {...rest}
      >
